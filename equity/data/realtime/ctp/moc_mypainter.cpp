...
static const char qt_meta_stringdata_MyPainter[] = {
    "MyPainter\0\0lastprice\0drawPrice(double)\0"
};
...
void MyPainter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->drawPrice((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData MyPainter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyPainter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyPainter,
      qt_meta_data_MyPainter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyPainter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyPainter))
        return static_cast<void*>(const_cast< MyPainter*>(this));
    if (!strcmp(_clname, "QPainter"))
        return static_cast< QPainter*>(const_cast< MyPainter*>(this));
